...
namespace Project.DataAccess
{
    ...
    /// 开发日期: 2012年06月
    /// </summary>
    public class SysBaseDao : DAOCommConfig
    {
        public Database Db
        {
            get
            {
                return DatabaseFactory.CreateDatabase(DBLink.SysDBLink.ToString());
            }
        }
        /// <summary>
        /// 获取当前数据库服务器的日期时间
        ...
        /// <returns></returns>
        public DataTable GetAlarmTypeData()
        {
            string sql = "select KeyId,TargetName from AlarmTargetType";
